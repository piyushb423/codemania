  ...
  if ($result->num_rows > 0 ) {
    while($row = $result->fetch_assoc()) {
     ...
     //echo '<input type="submit" value="View Answer" style="font-size:15px; float:left"><br>';
      ...
      echo'<input type="submit" class="myButton" type="submit"  style="font-size:10px" value="View Answer" >';
      echo '</form>';
      echo '</div>';
      ...
      echo'<input type="submit" class="myButton" type="submit"  style="font-size:10px" value="Tag" >';
      echo '</form>';
      echo '</div><br>';
